...
En utilisant l’ensemble des fonctions personnalisées crées précédemment, créer un formulaire complet qui contient les
...
// Autre moyen pour afficher l'option 3 => AU LIEU D'UTILISER "ECHO" pour afficher la liste déroulante. Utiliser une fonction RETURN
function alimenterListeDeroulanteReturn($array)
{
    $resultat = "<select name = 'civilité'> ";
    foreach ($array as $choixforma) {

        $resultat .= "<option value = '$choixforma'> $choixforma 
        </option>"; // OPTION VALUE permet de faire une liste déroulante. 


    }
    $resultat .= "</select>";
    $resultat .= "<input type = 'submit' value = 'Ok'/>";
...
echo alimenterListeDeroulanteReturn($choixForma);